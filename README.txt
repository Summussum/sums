...
As of 08/24/24, this application is a work in progress developed by Summussum, correlating to the repository: github.com/Summussum.
...
If you are interested in this project please let me know! There are plans to host updates of this site in the future, so please check back in for a live url. NOTE: the demo site has no security guarantees and it is advised to not post any personal financial data to this site. 

If you feel the desire to test with actual data, there are sample datasets available online.
...
OPEN SOURCE LICENSE FOR SUM'S SUMS:
